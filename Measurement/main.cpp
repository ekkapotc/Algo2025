...
int main(int argc, char **argv) {
  ...
  std::vector<size_t> problem_sizes = {10,   20,    100,   200,    1000,
                                       2000, 10000, 20000, 100000, 200000};

  std::cout << std::left << std::setw(15) << "Problem Size" << std::setw(15)
            << "Time (ms)"
            << "\n";
  ...
  for (auto size : problem_sizes) {
    ...
    std::cout << std::setw(15) << size << std::setw(15)
              << total_elapsed / N_RUNS << std::endl;
